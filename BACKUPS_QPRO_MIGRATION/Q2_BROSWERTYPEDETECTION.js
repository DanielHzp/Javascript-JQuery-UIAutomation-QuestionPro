...
(function () {
    ...
    console.log("[QP] Browser Type cv.Data.browserType:", window.cvData.browserType);
...
window.updateURLStatus = function (status) {
    ...
    try {
        ...
        console.log("[QP] Current URL:", window.location.href);

    } catch (e) {

        console.error("[QP] URL update failed:", e);
...
console.log("[QP] MutationObserver attached");